...
exports.run = (overrideConfig = {}) => { // eslint-disable-line complexity
	let conf = {};
	let confError = null;
	try {
		conf = loadConf();
	...
	const cli = meow(`
		...
		Options
		  ...
		  --no-fork               Don't run tests in forked processes
	...
	`, {
		flags: {
			...
			fork: {
				type: 'boolean',
				default: typeof conf.fork === 'undefined' ? true : conf.fork
			},
			verbose: {
				type: 'boolean',
				alias: 'v',
	...
	Object.assign(conf, cli.flags, overrideConfig);
